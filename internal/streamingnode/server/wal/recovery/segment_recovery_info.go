...
// IsHandoffPending returns true if the segment is fenced by a TEXT release fence
...
// ObserveHandoffPending is called when a TEXT release fence seals the segment
