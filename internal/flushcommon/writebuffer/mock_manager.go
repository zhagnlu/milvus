...
// GetTextFlushProgress provides a mock function with given fields: ctx, channel, segmentIDs, fenceTs
func (_m *MockBufferManager) GetTextFlushProgress(ctx context.Context, channel string, segmentIDs []int64, fenceTs uint64) ([]TextFlushSegmentProgress, error) {
	...
	var r0 []TextFlushSegmentProgress
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, []int64, uint64) ([]TextFlushSegmentProgress, error)); ok {
		return rf(ctx, channel, segmentIDs, fenceTs)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, []int64, uint64) []TextFlushSegmentProgress); ok {
		r0 = rf(ctx, channel, segmentIDs, fenceTs)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]TextFlushSegmentProgress)
		}
	}
...
// MockBufferManager_GetTextFlushProgress_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetTextFlushProgress'
type MockBufferManager_GetTextFlushProgress_Call struct {
	*mock.Call
}
...
//   - segmentIDs []int64
//   - fenceTs uint64
func (_e *MockBufferManager_Expecter) GetTextFlushProgress(ctx interface{}, channel interface{}, segmentIDs interface{}, fenceTs interface{}) *MockBufferManager_GetTextFlushProgress_Call {
	return &MockBufferManager_GetTextFlushProgress_Call{Call: _e.mock.On("GetTextFlushProgress", ctx, channel, segmentIDs, fenceTs)}
}

func (_c *MockBufferManager_GetTextFlushProgress_Call) Run(run func(ctx context.Context, channel string, segmentIDs []int64, fenceTs uint64)) *MockBufferManager_GetTextFlushProgress_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockBufferManager_GetTextFlushProgress_Call) Return(_a0 []TextFlushSegmentProgress, _a1 error) *MockBufferManager_GetTextFlushProgress_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockBufferManager_GetTextFlushProgress_Call) RunAndReturn(run func(context.Context, string, []int64, uint64) ([]TextFlushSegmentProgress, error)) *MockBufferManager_GetTextFlushProgress_Call {
	_c.Call.Return(run)
	return _c
}
