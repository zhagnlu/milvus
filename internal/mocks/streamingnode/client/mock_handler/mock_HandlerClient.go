...
import (
	...
	writebuffer "github.com/milvus-io/milvus/internal/flushcommon/writebuffer"
)
...
// GetTextFlushProgress provides a mock function with given fields: ctx, vchannel, segmentIDs, fenceTs
func (_m *MockHandlerClient) GetTextFlushProgress(ctx context.Context, vchannel string, segmentIDs []int64, fenceTs uint64) ([]writebuffer.TextFlushSegmentProgress, error) {
	ret := _m.Called(ctx, vchannel, segmentIDs, fenceTs)

	if len(ret) == 0 {
		panic("no return value specified for GetTextFlushProgress")
	}

	var r0 []writebuffer.TextFlushSegmentProgress
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, []int64, uint64) ([]writebuffer.TextFlushSegmentProgress, error)); ok {
		return rf(ctx, vchannel, segmentIDs, fenceTs)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, []int64, uint64) []writebuffer.TextFlushSegmentProgress); ok {
		r0 = rf(ctx, vchannel, segmentIDs, fenceTs)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]writebuffer.TextFlushSegmentProgress)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, string, []int64, uint64) error); ok {
		r1 = rf(ctx, vchannel, segmentIDs, fenceTs)
	} else {
		r1 = ret.Error(1)
	}
...
// MockHandlerClient_GetTextFlushProgress_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetTextFlushProgress'
type MockHandlerClient_GetTextFlushProgress_Call struct {
	*mock.Call
}
...
//   - segmentIDs []int64
//   - fenceTs uint64
func (_e *MockHandlerClient_Expecter) GetTextFlushProgress(ctx interface{}, vchannel interface{}, segmentIDs interface{}, fenceTs interface{}) *MockHandlerClient_GetTextFlushProgress_Call {
	return &MockHandlerClient_GetTextFlushProgress_Call{Call: _e.mock.On("GetTextFlushProgress", ctx, vchannel, segmentIDs, fenceTs)}
}

func (_c *MockHandlerClient_GetTextFlushProgress_Call) Run(run func(ctx context.Context, vchannel string, segmentIDs []int64, fenceTs uint64)) *MockHandlerClient_GetTextFlushProgress_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockHandlerClient_GetTextFlushProgress_Call) Return(_a0 []writebuffer.TextFlushSegmentProgress, _a1 error) *MockHandlerClient_GetTextFlushProgress_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockHandlerClient_GetTextFlushProgress_Call) RunAndReturn(run func(context.Context, string, []int64, uint64) ([]writebuffer.TextFlushSegmentProgress, error)) *MockHandlerClient_GetTextFlushProgress_Call {
	_c.Call.Return(run)
	return _c
}
