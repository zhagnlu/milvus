...
func (_m *MockWALAccesser) GetTextFlushProgress(ctx context.Context, vchannel string, segmentIDs []int64, fenceTs uint64) ([]writebuffer.TextFlushSegmentProgress, error) {
...
// MockWALAccesser_GetTextFlushProgress_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetTextFlushProgress'
type MockWALAccesser_GetTextFlushProgress_Call struct {
	*mock.Call
}
...
//   - segmentIDs []int64
//   - fenceTs uint64
func (_e *MockWALAccesser_Expecter) GetTextFlushProgress(ctx interface{}, vchannel interface{}, segmentIDs interface{}, fenceTs interface{}) *MockWALAccesser_GetTextFlushProgress_Call {
	return &MockWALAccesser_GetTextFlushProgress_Call{Call: _e.mock.On("GetTextFlushProgress", ctx, vchannel, segmentIDs, fenceTs)}
}

func (_c *MockWALAccesser_GetTextFlushProgress_Call) Run(run func(ctx context.Context, vchannel string, segmentIDs []int64, fenceTs uint64)) *MockWALAccesser_GetTextFlushProgress_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockWALAccesser_GetTextFlushProgress_Call) Return(_a0 []writebuffer.TextFlushSegmentProgress, _a1 error) *MockWALAccesser_GetTextFlushProgress_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockWALAccesser_GetTextFlushProgress_Call) RunAndReturn(run func(context.Context, string, []int64, uint64) ([]writebuffer.TextFlushSegmentProgress, error)) *MockWALAccesser_GetTextFlushProgress_Call {
	_c.Call.Return(run)
	return _c
}
