...
func (w *walAccesserImpl) GetTextFlushProgress(ctx context.Context, vchannel string, segmentIDs []int64, fenceTs uint64) ([]writebuffer.TextFlushSegmentProgress, error) {
	return w.handlerClient.GetTextFlushProgress(ctx, vchannel, segmentIDs, fenceTs)
}
