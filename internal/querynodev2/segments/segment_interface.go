...
type FlushResult struct {
	...
	ManifestPath string
	// CommittedVersion is the manifest version committed by this flush.
	// This should be recorded and used as ReadVersion for subsequent flushes
	// only after SaveBinlogPaths succeeds.
