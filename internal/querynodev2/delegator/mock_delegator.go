...
func (_m *MockShardDelegator) ProcessManualFlush(ctx context.Context, flushTs uint64) {
	_m.Called(ctx, flushTs)
}
...
func (_c *MockShardDelegator_ProcessManualFlush_Call) Return() *MockShardDelegator_ProcessManualFlush_Call {
	_c.Call.Return()
	return _c
}

func (_c *MockShardDelegator_ProcessManualFlush_Call) RunAndReturn(run func(context.Context, uint64)) *MockShardDelegator_ProcessManualFlush_Call {
	_c.Run(run)
	return _c
}
