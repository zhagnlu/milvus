...
TEST(ScalarIndexCreatorTest, CreateTextMatchIndexForTextField) {
    ...
    field_meta.field_schema.set_data_type(milvus::proto::schema::DataType::Text);
    field_meta.field_schema.set_fieldid(101);
    field_meta.field_schema.set_name("text");
    field_meta.field_schema.add_type_params()->set_key(
        milvus::common::ENABLE_ANALYZER);
    field_meta.field_schema.mutable_type_params(0)->set_value("true");
    field_meta.field_schema.add_type_params()->set_key(
        milvus::common::ANALYZER_PARAMS);
    ...
    auto creator = milvus::indexbuilder::IndexFactory::GetInstance().CreateIndex(
