...
//const int64_t DEFAULT_DISK_INDEX_MAX_MEMORY_LIMIT = 67108860;  // gigabytes
const int64_t DEFAULT_DISK_INDEX_MAX_MEMORY_LIMIT = 20971520;  // gigabytes
const int64_t DEFAULT_THREAD_CORE_COEFFICIENT = 10;
