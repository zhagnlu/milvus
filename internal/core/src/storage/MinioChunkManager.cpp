...
MinioChunkManager::MinioChunkManager(const std::string& endpoint,
    ...
    std::cout << "init MinioChunkManager with parameter[endpoint: '" << endpoint << "', access_key:'" << access_key
              << "', access_value:'" << access_value << "', default_bucket_name:'" << bucket_name << "', use_secure:'"
