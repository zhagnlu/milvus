...
TEST(Expr, TestCompareWithScalarIndexMaris) {
    ...
    load_index_info.index = std::shared_ptr<milvus::Index::ScalarIndexSort<std::string>>(str1_index.get());
    seg->LoadIndex(load_index_info);
    ...
    load_index_info.field_type = DataType::VARCHAR;
    load_index_info.index = std::shared_ptr<milvus::Index::ScalarIndexSort<std::string>>(str2_index.get());
    seg->LoadIndex(load_index_info);
