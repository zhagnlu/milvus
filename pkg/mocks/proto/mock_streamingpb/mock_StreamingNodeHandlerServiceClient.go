...
// GetTextFlushProgress provides a mock function with given fields: ctx, in, opts
func (_m *MockStreamingNodeHandlerServiceClient) GetTextFlushProgress(ctx context.Context, in *streamingpb.GetTextFlushProgressRequest, opts ...grpc.CallOption) (*streamingpb.GetTextFlushProgressResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	if len(ret) == 0 {
		panic("no return value specified for GetTextFlushProgress")
	}

	var r0 *streamingpb.GetTextFlushProgressResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *streamingpb.GetTextFlushProgressRequest, ...grpc.CallOption) (*streamingpb.GetTextFlushProgressResponse, error)); ok {
		return rf(ctx, in, opts...)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *streamingpb.GetTextFlushProgressRequest, ...grpc.CallOption) *streamingpb.GetTextFlushProgressResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*streamingpb.GetTextFlushProgressResponse)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, *streamingpb.GetTextFlushProgressRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
...
// MockStreamingNodeHandlerServiceClient_GetTextFlushProgress_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetTextFlushProgress'
type MockStreamingNodeHandlerServiceClient_GetTextFlushProgress_Call struct {
	*mock.Call
}

// GetTextFlushProgress is a helper method to define mock.On call
//   - ctx context.Context
//   - in *streamingpb.GetTextFlushProgressRequest
//   - opts ...grpc.CallOption
func (_e *MockStreamingNodeHandlerServiceClient_Expecter) GetTextFlushProgress(ctx interface{}, in interface{}, opts ...interface{}) *MockStreamingNodeHandlerServiceClient_GetTextFlushProgress_Call {
	return &MockStreamingNodeHandlerServiceClient_GetTextFlushProgress_Call{Call: _e.mock.On("GetTextFlushProgress",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *MockStreamingNodeHandlerServiceClient_GetTextFlushProgress_Call) Run(run func(ctx context.Context, in *streamingpb.GetTextFlushProgressRequest, opts ...grpc.CallOption)) *MockStreamingNodeHandlerServiceClient_GetTextFlushProgress_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
			if a != nil {
		...
		run(args[0].(context.Context), args[1].(*streamingpb.GetTextFlushProgressRequest), variadicArgs...)
	})
	return _c
}

func (_c *MockStreamingNodeHandlerServiceClient_GetTextFlushProgress_Call) Return(_a0 *streamingpb.GetTextFlushProgressResponse, _a1 error) *MockStreamingNodeHandlerServiceClient_GetTextFlushProgress_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockStreamingNodeHandlerServiceClient_GetTextFlushProgress_Call) RunAndReturn(run func(context.Context, *streamingpb.GetTextFlushProgressRequest, ...grpc.CallOption) (*streamingpb.GetTextFlushProgressResponse, error)) *MockStreamingNodeHandlerServiceClient_GetTextFlushProgress_Call {
	_c.Call.Return(run)
	return _c
}
