...
type TextFlushSourceMode int32

const (
	TextFlushSourceMode_TEXT_FLUSH_SOURCE_UNKNOWN      TextFlushSourceMode = 0
	TextFlushSourceMode_TEXT_FLUSH_SOURCE_WRITE_BUFFER TextFlushSourceMode = 1
	TextFlushSourceMode_TEXT_FLUSH_SOURCE_GROWING      TextFlushSourceMode = 2
)

// Enum value maps for TextFlushSourceMode.
var (
	TextFlushSourceMode_name = map[int32]string{
		0: "TEXT_FLUSH_SOURCE_UNKNOWN",
		1: "TEXT_FLUSH_SOURCE_WRITE_BUFFER",
		2: "TEXT_FLUSH_SOURCE_GROWING",
	}
	TextFlushSourceMode_value = map[string]int32{
		"TEXT_FLUSH_SOURCE_UNKNOWN":      0,
		"TEXT_FLUSH_SOURCE_WRITE_BUFFER": 1,
		"TEXT_FLUSH_SOURCE_GROWING":      2,
	}
)

func (x TextFlushSourceMode) Enum() *TextFlushSourceMode {
	p := new(TextFlushSourceMode)
	*p = x
	return p
}

func (x TextFlushSourceMode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TextFlushSourceMode) Descriptor() protoreflect.EnumDescriptor {
	return file_streaming_proto_enumTypes[4].Descriptor()
}

func (TextFlushSourceMode) Type() protoreflect.EnumType {
	return &file_streaming_proto_enumTypes[4]
}

func (x TextFlushSourceMode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TextFlushSourceMode.Descriptor instead.
func (TextFlushSourceMode) EnumDescriptor() ([]byte, []int) {
...
var (
	WALRateLimitState_name = map[int32]string{
		0: "WAL_RATE_LIMIT_STATE_UNKNOWN",
		1: "WAL_RATE_LIMIT_STATE_NORMAL",
		2: "WAL_RATE_LIMIT_STATE_SLOWDOWN",
		3: "WAL_RATE_LIMIT_STATE_REJECT",
	}
	WALRateLimitState_value = map[string]int32{
		"WAL_RATE_LIMIT_STATE_UNKNOWN":  0,
		"WAL_RATE_LIMIT_STATE_NORMAL":   1,
		"WAL_RATE_LIMIT_STATE_SLOWDOWN": 2,
		"WAL_RATE_LIMIT_STATE_REJECT":   3,
	}
)

func (x WALRateLimitState) Enum() *WALRateLimitState {
	p := new(WALRateLimitState)
	*p = x
	return p
}

func (x WALRateLimitState) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (WALRateLimitState) Descriptor() protoreflect.EnumDescriptor {
	return file_streaming_proto_enumTypes[5].Descriptor()
}

func (WALRateLimitState) Type() protoreflect.EnumType {
	return &file_streaming_proto_enumTypes[5]
}

func (x WALRateLimitState) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use WALRateLimitState.Descriptor instead.
func (WALRateLimitState) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	SegmentAssignmentState_SEGMENT_ASSIGNMENT_STATE_HANDOFF_PENDING SegmentAssignmentState = 3 // fenced by TEXT release, waiting for user flush/drop.
)
...
var (
	SegmentAssignmentState_name = map[int32]string{
		...
		3: "SEGMENT_ASSIGNMENT_STATE_HANDOFF_PENDING",
	}
	SegmentAssignmentState_value = map[string]int32{
		...
		"SEGMENT_ASSIGNMENT_STATE_HANDOFF_PENDING": 3,
	}
)
...
func (SegmentAssignmentState) Descriptor() protoreflect.EnumDescriptor {
	return file_streaming_proto_enumTypes[8].Descriptor()
}

func (SegmentAssignmentState) Type() protoreflect.EnumType {
	return &file_streaming_proto_enumTypes[8]
}
...
type UpdateReplicateConfigurationRequest struct {
	...
	ForcePromote  bool                             `protobuf:"varint,2,opt,name=force_promote,json=forcePromote,proto3" json:"force_promote,omitempty"`
}
...
func (x *UpdateReplicateConfigurationRequest) GetForcePromote() bool {
	if x != nil {
...
func (x *GetSalvageCheckpointRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *GetSalvageCheckpointResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// GetTextFlushProgressRequest is the request of GetTextFlushProgress service.
type GetTextFlushProgressRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	// Empty segment_ids means returning all tracked TEXT growing-source segments.
	SegmentIds []int64 `protobuf:"varint,3,rep,packed,name=segment_ids,json=segmentIds,proto3" json:"segment_ids,omitempty"`
	FenceTs    uint64  `protobuf:"varint,4,opt,name=fence_ts,json=fenceTs,proto3" json:"fence_ts,omitempty"`
}

func (x *GetTextFlushProgressRequest) Reset() {
	*x = GetTextFlushProgressRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetTextFlushProgressRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTextFlushProgressRequest) ProtoMessage() {}

func (x *GetTextFlushProgressRequest) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[38]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTextFlushProgressRequest.ProtoReflect.Descriptor instead.
func (*GetTextFlushProgressRequest) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{38}
}

func (x *GetTextFlushProgressRequest) GetPchannel() *PChannelInfo {
	if x != nil {
		return x.Pchannel
	}
	return nil
...
func (x *GetTextFlushProgressRequest) GetVchannel() string {
	if x != nil {
		return x.Vchannel
	}
	return ""
...
func (x *GetTextFlushProgressRequest) GetSegmentIds() []int64 {
	if x != nil {
		return x.SegmentIds
	}
	return nil
...
func (x *GetTextFlushProgressRequest) GetFenceTs() uint64 {
	if x != nil {
		return x.FenceTs
	}
	return 0
...
type TextFlushSegmentProgress struct {
	...
	TargetOffset       int64               `protobuf:"varint,2,opt,name=target_offset,json=targetOffset,proto3" json:"target_offset,omitempty"`
	HasGrowingProgress bool                `protobuf:"varint,3,opt,name=has_growing_progress,json=hasGrowingProgress,proto3" json:"has_growing_progress,omitempty"`
	SourceMode         TextFlushSourceMode `protobuf:"varint,4,opt,name=source_mode,json=sourceMode,proto3,enum=milvus.proto.streaming.TextFlushSourceMode" json:"source_mode,omitempty"`
}

func (x *TextFlushSegmentProgress) Reset() {
	*x = TextFlushSegmentProgress{}
	if protoimpl.UnsafeEnabled {
...
func (x *TextFlushSegmentProgress) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TextFlushSegmentProgress) ProtoMessage() {}

func (x *TextFlushSegmentProgress) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[39]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TextFlushSegmentProgress.ProtoReflect.Descriptor instead.
func (*TextFlushSegmentProgress) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{39}
}

func (x *TextFlushSegmentProgress) GetSegmentId() int64 {
	if x != nil {
		return x.SegmentId
	}
	return 0
...
func (x *TextFlushSegmentProgress) GetTargetOffset() int64 {
	if x != nil {
...
func (x *TextFlushSegmentProgress) GetHasGrowingProgress() bool {
	if x != nil {
		return x.HasGrowingProgress
	}
	return false
}

func (x *TextFlushSegmentProgress) GetSourceMode() TextFlushSourceMode {
	if x != nil {
		return x.SourceMode
	}
	return TextFlushSourceMode_TEXT_FLUSH_SOURCE_UNKNOWN
}

// GetTextFlushProgressResponse is the response of GetTextFlushProgress service.
type GetTextFlushProgressResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Progress []*TextFlushSegmentProgress `protobuf:"bytes,1,rep,name=progress,proto3" json:"progress,omitempty"`
}

func (x *GetTextFlushProgressResponse) Reset() {
	*x = GetTextFlushProgressResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetTextFlushProgressResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetTextFlushProgressResponse) ProtoMessage() {}

func (x *GetTextFlushProgressResponse) ProtoReflect() protoreflect.Message {
	mi := &file_streaming_proto_msgTypes[40]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetTextFlushProgressResponse.ProtoReflect.Descriptor instead.
func (*GetTextFlushProgressResponse) Descriptor() ([]byte, []int) {
	return file_streaming_proto_rawDescGZIP(), []int{40}
}

func (x *GetTextFlushProgressResponse) GetProgress() []*TextFlushSegmentProgress {
	if x != nil {
		return x.Progress
	}
	return nil
...
func (x *ProduceResponse) GetRateLimit() *ProduceRateLimitResponse {
	if x, ok := x.GetResponse().(*ProduceResponse_RateLimit); ok {
		return x.RateLimit
	}
	return nil
}
...
type ProduceResponse_RateLimit struct {
	RateLimit *ProduceRateLimitResponse `protobuf:"bytes,4,opt,name=rate_limit,json=rateLimit,proto3,oneof"`
}
...
func (x *ProduceRateLimitResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *ProduceRateLimitResponse) GetState() WALRateLimitState {
	...
	return WALRateLimitState_WAL_RATE_LIMIT_STATE_UNKNOWN
}

func (x *ProduceRateLimitResponse) GetRate() int64 {
	if x != nil {
		return x.Rate
	}
	return 0
...
func (x *ReplicateConfigurationMeta) GetForcePromoted() bool {
	if x != nil {
		return x.ForcePromoted
	}
	return false
}
...
func (x *ReplicatePChannelMeta) GetSkipGetReplicateCheckpoint() bool {
	if x != nil {
		return x.SkipGetReplicateCheckpoint
	}
	return false
}
...
var file_streaming_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x1a, 0x10, 0x64, 0x61, 0x74, 0x61, 0x5f,
	0x63, 0x6f, 0x6f, 0x72, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x0e, 0x6d, 0x65, 0x73,
	0x73, 0x61, 0x67, 0x65, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x0c, 0x63, 0x6f, 0x6d,
	...
	0x52, 0x0b, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x73, 0x22, 0xb7, 0x01,
	0x0a, 0x1b, 0x47, 0x65, 0x74, 0x54, 0x65, 0x78, 0x74, 0x46, 0x6c, 0x75, 0x73, 0x68, 0x50, 0x72,
	0x6f, 0x67, 0x72, 0x65, 0x73, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x40, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x49, 0x4e, 0x47, 0x10, 0x01, 0x12, 0x24, 0x0a, 0x20, 0x53, 0x45, 0x47, 0x4d, 0x45, 0x4e, 0x54,
	0x5f, 0x41, 0x53, 0x53, 0x49, 0x47, 0x4e, 0x4d, 0x45, 0x4e, 0x54, 0x5f, 0x53, 0x54, 0x41, 0x54,
	0x45, 0x5f, 0x46, 0x4c, 0x55, 0x53, 0x48, 0x45, 0x44, 0x10, 0x02, 0x12, 0x2c, 0x0a, 0x28, 0x53,
	0x45, 0x47, 0x4d, 0x45, 0x4e, 0x54, 0x5f, 0x41, 0x53, 0x53, 0x49, 0x47, 0x4e, 0x4d, 0x45, 0x4e,
	0x54, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x45, 0x5f, 0x48, 0x41, 0x4e, 0x44, 0x4f, 0x46, 0x46, 0x5f,
	0x50, 0x45, 0x4e, 0x44, 0x49, 0x4e, 0x47, 0x10, 0x03, 0x2a, 0x3f, 0x0a, 0x0d, 0x41, 0x6c, 0x74,
	...
	0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x32, 0xf9, 0x04, 0x0a, 0x1b, 0x53, 0x74, 0x72, 0x65, 0x61,
	...
	,
	...
	0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67, 0x70, 0x62, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_streaming_proto_enumTypes = make([]protoimpl.EnumInfo, 10)
var file_streaming_proto_msgTypes = make([]protoimpl.MessageInfo, 86)
var file_streaming_proto_goTypes = []interface{}{
	...
	(TextFlushSourceMode)(0),                          // 4: milvus.proto.streaming.TextFlushSourceMode
	(WALRateLimitState)(0),                            // 5: milvus.proto.streaming.WALRateLimitState
	(VChannelState)(0),                                // 6: milvus.proto.streaming.VChannelState
	(VChannelSchemaState)(0),                          // 7: milvus.proto.streaming.VChannelSchemaState
	(SegmentAssignmentState)(0),                       // 8: milvus.proto.streaming.SegmentAssignmentState
	(AlterWALStage)(0),                                // 9: milvus.proto.streaming.AlterWALStage
	(*PChannelInfo)(nil),                              // 10: milvus.proto.streaming.PChannelInfo
	(*PChannelAssignmentLog)(nil),                     // 11: milvus.proto.streaming.PChannelAssignmentLog
	(*PChannelMeta)(nil),                              // 12: milvus.proto.streaming.PChannelMeta
	(*CChannelMeta)(nil),                              // 13: milvus.proto.streaming.CChannelMeta
	(*StreamingVersion)(nil),                          // 14: milvus.proto.streaming.StreamingVersion
	(*VersionPair)(nil),                               // 15: milvus.proto.streaming.VersionPair
	(*BroadcastTask)(nil),                             // 16: milvus.proto.streaming.BroadcastTask
	(*AckedResult)(nil),                               // 17: milvus.proto.streaming.AckedResult
	(*AckedCheckpoint)(nil),                           // 18: milvus.proto.streaming.AckedCheckpoint
	(*BroadcastRequest)(nil),                          // 19: milvus.proto.streaming.BroadcastRequest
	(*BroadcastResponse)(nil),                         // 20: milvus.proto.streaming.BroadcastResponse
	(*BroadcastAckRequest)(nil),                       // 21: milvus.proto.streaming.BroadcastAckRequest
	(*BroadcastAckResponse)(nil),                      // 22: milvus.proto.streaming.BroadcastAckResponse
	(*UpdateReplicateConfigurationRequest)(nil),       // 23: milvus.proto.streaming.UpdateReplicateConfigurationRequest
	(*UpdateReplicateConfigurationResponse)(nil),      // 24: milvus.proto.streaming.UpdateReplicateConfigurationResponse
	(*UpdateWALBalancePolicyRequest)(nil),             // 25: milvus.proto.streaming.UpdateWALBalancePolicyRequest
	(*WALBalancePolicyConfig)(nil),                    // 26: milvus.proto.streaming.WALBalancePolicyConfig
	(*WALBalancePolicyNodes)(nil),                     // 27: milvus.proto.streaming.WALBalancePolicyNodes
	(*UpdateWALBalancePolicyResponse)(nil),            // 28: milvus.proto.streaming.UpdateWALBalancePolicyResponse
	(*AssignmentDiscoverRequest)(nil),                 // 29: milvus.proto.streaming.AssignmentDiscoverRequest
	(*ReportAssignmentErrorRequest)(nil),              // 30: milvus.proto.streaming.ReportAssignmentErrorRequest
	(*CloseAssignmentDiscoverRequest)(nil),            // 31: milvus.proto.streaming.CloseAssignmentDiscoverRequest
	(*AssignmentDiscoverResponse)(nil),                // 32: milvus.proto.streaming.AssignmentDiscoverResponse
	(*FullStreamingNodeAssignmentWithVersion)(nil),    // 33: milvus.proto.streaming.FullStreamingNodeAssignmentWithVersion
	(*CChannelAssignment)(nil),                        // 34: milvus.proto.streaming.CChannelAssignment
	(*CloseAssignmentDiscoverResponse)(nil),           // 35: milvus.proto.streaming.CloseAssignmentDiscoverResponse
	(*StreamingNodeInfo)(nil),                         // 36: milvus.proto.streaming.StreamingNodeInfo
	(*StreamingNodeAssignment)(nil),                   // 37: milvus.proto.streaming.StreamingNodeAssignment
	(*DeliverPolicy)(nil),                             // 38: milvus.proto.streaming.DeliverPolicy
	(*DeliverFilter)(nil),                             // 39: milvus.proto.streaming.DeliverFilter
	(*DeliverFilterTimeTickGT)(nil),                   // 40: milvus.proto.streaming.DeliverFilterTimeTickGT
	(*DeliverFilterTimeTickGTE)(nil),                  // 41: milvus.proto.streaming.DeliverFilterTimeTickGTE
	(*DeliverFilterMessageType)(nil),                  // 42: milvus.proto.streaming.DeliverFilterMessageType
	(*StreamingError)(nil),                            // 43: milvus.proto.streaming.StreamingError
	(*GetReplicateCheckpointRequest)(nil),             // 44: milvus.proto.streaming.GetReplicateCheckpointRequest
	(*GetReplicateCheckpointResponse)(nil),            // 45: milvus.proto.streaming.GetReplicateCheckpointResponse
	(*GetSalvageCheckpointRequest)(nil),               // 46: milvus.proto.streaming.GetSalvageCheckpointRequest
	(*GetSalvageCheckpointResponse)(nil),              // 47: milvus.proto.streaming.GetSalvageCheckpointResponse
	(*GetTextFlushProgressRequest)(nil),               // 48: milvus.proto.streaming.GetTextFlushProgressRequest
	(*TextFlushSegmentProgress)(nil),                  // 49: milvus.proto.streaming.TextFlushSegmentProgress
	(*GetTextFlushProgressResponse)(nil),              // 50: milvus.proto.streaming.GetTextFlushProgressResponse
	(*ProduceRequest)(nil),                            // 51: milvus.proto.streaming.ProduceRequest
	(*CreateProducerRequest)(nil),                     // 52: milvus.proto.streaming.CreateProducerRequest
	(*ProduceMessageRequest)(nil),                     // 53: milvus.proto.streaming.ProduceMessageRequest
	(*CloseProducerRequest)(nil),                      // 54: milvus.proto.streaming.CloseProducerRequest
	(*ProduceResponse)(nil),                           // 55: milvus.proto.streaming.ProduceResponse
	(*CreateProducerResponse)(nil),                    // 56: milvus.proto.streaming.CreateProducerResponse
	(*ProduceMessageResponse)(nil),                    // 57: milvus.proto.streaming.ProduceMessageResponse
	(*ProduceRateLimitResponse)(nil),                  // 58: milvus.proto.streaming.ProduceRateLimitResponse
	(*ProduceMessageResponseResult)(nil),              // 59: milvus.proto.streaming.ProduceMessageResponseResult
	(*CloseProducerResponse)(nil),                     // 60: milvus.proto.streaming.CloseProducerResponse
	(*ConsumeRequest)(nil),                            // 61: milvus.proto.streaming.ConsumeRequest
	(*CloseConsumerRequest)(nil),                      // 62: milvus.proto.streaming.CloseConsumerRequest
	(*CreateConsumerRequest)(nil),                     // 63: milvus.proto.streaming.CreateConsumerRequest
	(*CreateVChannelConsumersRequest)(nil),            // 64: milvus.proto.streaming.CreateVChannelConsumersRequest
	(*CreateVChannelConsumerRequest)(nil),             // 65: milvus.proto.streaming.CreateVChannelConsumerRequest
	(*CreateVChannelConsumersResponse)(nil),           // 66: milvus.proto.streaming.CreateVChannelConsumersResponse
	(*CreateVChannelConsumerResponse)(nil),            // 67: milvus.proto.streaming.CreateVChannelConsumerResponse
	(*CloseVChannelConsumerRequest)(nil),              // 68: milvus.proto.streaming.CloseVChannelConsumerRequest
	(*CloseVChannelConsumerResponse)(nil),             // 69: milvus.proto.streaming.CloseVChannelConsumerResponse
	(*ConsumeResponse)(nil),                           // 70: milvus.proto.streaming.ConsumeResponse
	(*CreateConsumerResponse)(nil),                    // 71: milvus.proto.streaming.CreateConsumerResponse
	(*ConsumeMessageReponse)(nil),                     // 72: milvus.proto.streaming.ConsumeMessageReponse
	(*CloseConsumerResponse)(nil),                     // 73: milvus.proto.streaming.CloseConsumerResponse
	(*StreamingNodeManagerAssignRequest)(nil),         // 74: milvus.proto.streaming.StreamingNodeManagerAssignRequest
	(*StreamingNodeManagerAssignResponse)(nil),        // 75: milvus.proto.streaming.StreamingNodeManagerAssignResponse
	(*StreamingNodeManagerRemoveRequest)(nil),         // 76: milvus.proto.streaming.StreamingNodeManagerRemoveRequest
	(*StreamingNodeManagerRemoveResponse)(nil),        // 77: milvus.proto.streaming.StreamingNodeManagerRemoveResponse
	(*StreamingNodeManagerCollectStatusRequest)(nil),  // 78: milvus.proto.streaming.StreamingNodeManagerCollectStatusRequest
	(*StreamingNodeMetrics)(nil),                      // 79: milvus.proto.streaming.StreamingNodeMetrics
	(*StreamingNodeWALMetrics)(nil),                   // 80: milvus.proto.streaming.StreamingNodeWALMetrics
	(*StreamingNodeRWWALMetrics)(nil),                 // 81: milvus.proto.streaming.StreamingNodeRWWALMetrics
	(*StreamingNodeROWALMetrics)(nil),                 // 82: milvus.proto.streaming.StreamingNodeROWALMetrics
	(*StreamingNodeManagerCollectStatusResponse)(nil), // 83: milvus.proto.streaming.StreamingNodeManagerCollectStatusResponse
	(*VChannelMeta)(nil),                              // 84: milvus.proto.streaming.VChannelMeta
	(*CollectionInfoOfVChannel)(nil),                  // 85: milvus.proto.streaming.CollectionInfoOfVChannel
	(*CollectionSchemaOfVChannel)(nil),                // 86: milvus.proto.streaming.CollectionSchemaOfVChannel
	(*PartitionInfoOfVChannel)(nil),                   // 87: milvus.proto.streaming.PartitionInfoOfVChannel
	(*SegmentAssignmentMeta)(nil),                     // 88: milvus.proto.streaming.SegmentAssignmentMeta
	(*SegmentAssignmentStat)(nil),                     // 89: milvus.proto.streaming.SegmentAssignmentStat
	(*WALCheckpoint)(nil),                             // 90: milvus.proto.streaming.WALCheckpoint
	(*AlterWALState)(nil),                             // 91: milvus.proto.streaming.AlterWALState
	(*ReplicateConfigurationMeta)(nil),                // 92: milvus.proto.streaming.ReplicateConfigurationMeta
	(*ReplicatePChannelMeta)(nil),                     // 93: milvus.proto.streaming.ReplicatePChannelMeta
	nil,                                               // 94: milvus.proto.streaming.BroadcastResponse.ResultsEntry
	nil,                                               // 95: milvus.proto.streaming.AlterWALState.ConfigsEntry
	(*messagespb.Message)(nil),                        // 96: milvus.proto.messages.Message
	(*commonpb.MessageID)(nil),                        // 97: milvus.proto.common.MessageID
	(*commonpb.ImmutableMessage)(nil),                 // 98: milvus.proto.common.ImmutableMessage
	(*commonpb.ReplicateConfiguration)(nil),           // 99: milvus.proto.common.ReplicateConfiguration
	(*fieldmaskpb.FieldMask)(nil),                     // 100: google.protobuf.FieldMask
	(*emptypb.Empty)(nil),                             // 101: google.protobuf.Empty
	(messagespb.MessageType)(0),                       // 102: milvus.proto.messages.MessageType
	(*commonpb.ReplicateCheckpoint)(nil),              // 103: milvus.proto.common.ReplicateCheckpoint
	(*messagespb.TxnContext)(nil),                     // 104: milvus.proto.messages.TxnContext
	(*anypb.Any)(nil),                                 // 105: google.protobuf.Any
	(*schemapb.CollectionSchema)(nil),                 // 106: milvus.proto.schema.CollectionSchema
	(datapb.SegmentLevel)(0),                          // 107: milvus.proto.data.SegmentLevel
	(commonpb.WALName)(0),                             // 108: milvus.proto.common.WALName
	(*commonpb.MilvusCluster)(nil),                    // 109: milvus.proto.common.MilvusCluster
	(*milvuspb.GetComponentStatesRequest)(nil),        // 110: milvus.proto.milvus.GetComponentStatesRequest
...
var file_streaming_proto_depIdxs = []int32{
	...
	36,  // 1: milvus.proto.streaming.PChannelAssignmentLog.node:type_name -> milvus.proto.streaming.StreamingNodeInfo
	0,   // 2: milvus.proto.streaming.PChannelAssignmentLog.access_mode:type_name -> milvus.proto.streaming.PChannelAccessMode
	10,  // 3: milvus.proto.streaming.PChannelMeta.channel:type_name -> milvus.proto.streaming.PChannelInfo
	36,  // 4: milvus.proto.streaming.PChannelMeta.node:type_name -> milvus.proto.streaming.StreamingNodeInfo
	1,   // 5: milvus.proto.streaming.PChannelMeta.state:type_name -> milvus.proto.streaming.PChannelMetaState
	11,  // 6: milvus.proto.streaming.PChannelMeta.histories:type_name -> milvus.proto.streaming.PChannelAssignmentLog
	96,  // 7: milvus.proto.streaming.BroadcastTask.message:type_name -> milvus.proto.messages.Message
	2,   // 8: milvus.proto.streaming.BroadcastTask.state:type_name -> milvus.proto.streaming.BroadcastTaskState
	18,  // 9: milvus.proto.streaming.BroadcastTask.acked_checkpoints:type_name -> milvus.proto.streaming.AckedCheckpoint
	18,  // 10: milvus.proto.streaming.AckedResult.acked_checkpoints:type_name -> milvus.proto.streaming.AckedCheckpoint
	97,  // 11: milvus.proto.streaming.AckedCheckpoint.message_id:type_name -> milvus.proto.common.MessageID
	97,  // 12: milvus.proto.streaming.AckedCheckpoint.last_confirmed_message_id:type_name -> milvus.proto.common.MessageID
	96,  // 13: milvus.proto.streaming.BroadcastRequest.message:type_name -> milvus.proto.messages.Message
	94,  // 14: milvus.proto.streaming.BroadcastResponse.results:type_name -> milvus.proto.streaming.BroadcastResponse.ResultsEntry
	98,  // 15: milvus.proto.streaming.BroadcastAckRequest.message:type_name -> milvus.proto.common.ImmutableMessage
	99,  // 16: milvus.proto.streaming.UpdateReplicateConfigurationRequest.configuration:type_name -> milvus.proto.common.ReplicateConfiguration
	26,  // 17: milvus.proto.streaming.UpdateWALBalancePolicyRequest.config:type_name -> milvus.proto.streaming.WALBalancePolicyConfig
	27,  // 18: milvus.proto.streaming.UpdateWALBalancePolicyRequest.nodes:type_name -> milvus.proto.streaming.WALBalancePolicyNodes
	100, // 19: milvus.proto.streaming.UpdateWALBalancePolicyRequest.update_mask:type_name -> google.protobuf.FieldMask
	26,  // 20: milvus.proto.streaming.UpdateWALBalancePolicyResponse.config:type_name -> milvus.proto.streaming.WALBalancePolicyConfig
	30,  // 21: milvus.proto.streaming.AssignmentDiscoverRequest.report_error:type_name -> milvus.proto.streaming.ReportAssignmentErrorRequest
	31,  // 22: milvus.proto.streaming.AssignmentDiscoverRequest.close:type_name -> milvus.proto.streaming.CloseAssignmentDiscoverRequest
	10,  // 23: milvus.proto.streaming.ReportAssignmentErrorRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	43,  // 24: milvus.proto.streaming.ReportAssignmentErrorRequest.err:type_name -> milvus.proto.streaming.StreamingError
	33,  // 25: milvus.proto.streaming.AssignmentDiscoverResponse.full_assignment:type_name -> milvus.proto.streaming.FullStreamingNodeAssignmentWithVersion
	35,  // 26: milvus.proto.streaming.AssignmentDiscoverResponse.close:type_name -> milvus.proto.streaming.CloseAssignmentDiscoverResponse
	15,  // 27: milvus.proto.streaming.FullStreamingNodeAssignmentWithVersion.version:type_name -> milvus.proto.streaming.VersionPair
	37,  // 28: milvus.proto.streaming.FullStreamingNodeAssignmentWithVersion.assignments:type_name -> milvus.proto.streaming.StreamingNodeAssignment
	34,  // 29: milvus.proto.streaming.FullStreamingNodeAssignmentWithVersion.cchannel:type_name -> milvus.proto.streaming.CChannelAssignment
	99,  // 30: milvus.proto.streaming.FullStreamingNodeAssignmentWithVersion.replicate_configuration:type_name -> milvus.proto.common.ReplicateConfiguration
	14,  // 31: milvus.proto.streaming.FullStreamingNodeAssignmentWithVersion.streaming_version:type_name -> milvus.proto.streaming.StreamingVersion
	15,  // 32: milvus.proto.streaming.FullStreamingNodeAssignmentWithVersion.version_by_revision:type_name -> milvus.proto.streaming.VersionPair
	13,  // 33: milvus.proto.streaming.CChannelAssignment.meta:type_name -> milvus.proto.streaming.CChannelMeta
	36,  // 34: milvus.proto.streaming.StreamingNodeAssignment.node:type_name -> milvus.proto.streaming.StreamingNodeInfo
	10,  // 35: milvus.proto.streaming.StreamingNodeAssignment.channels:type_name -> milvus.proto.streaming.PChannelInfo
	101, // 36: milvus.proto.streaming.DeliverPolicy.all:type_name -> google.protobuf.Empty
	101, // 37: milvus.proto.streaming.DeliverPolicy.latest:type_name -> google.protobuf.Empty
	97,  // 38: milvus.proto.streaming.DeliverPolicy.start_from:type_name -> milvus.proto.common.MessageID
	97,  // 39: milvus.proto.streaming.DeliverPolicy.start_after:type_name -> milvus.proto.common.MessageID
	40,  // 40: milvus.proto.streaming.DeliverFilter.time_tick_gt:type_name -> milvus.proto.streaming.DeliverFilterTimeTickGT
	41,  // 41: milvus.proto.streaming.DeliverFilter.time_tick_gte:type_name -> milvus.proto.streaming.DeliverFilterTimeTickGTE
	42,  // 42: milvus.proto.streaming.DeliverFilter.message_type:type_name -> milvus.proto.streaming.DeliverFilterMessageType
	102, // 43: milvus.proto.streaming.DeliverFilterMessageType.message_types:type_name -> milvus.proto.messages.MessageType
	3,   // 44: milvus.proto.streaming.StreamingError.code:type_name -> milvus.proto.streaming.StreamingCode
	10,  // 45: milvus.proto.streaming.GetReplicateCheckpointRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	103, // 46: milvus.proto.streaming.GetReplicateCheckpointResponse.checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	10,  // 47: milvus.proto.streaming.GetSalvageCheckpointRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	103, // 48: milvus.proto.streaming.GetSalvageCheckpointResponse.checkpoints:type_name -> milvus.proto.common.ReplicateCheckpoint
	10,  // 49: milvus.proto.streaming.GetTextFlushProgressRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	4,   // 50: milvus.proto.streaming.TextFlushSegmentProgress.source_mode:type_name -> milvus.proto.streaming.TextFlushSourceMode
	49,  // 51: milvus.proto.streaming.GetTextFlushProgressResponse.progress:type_name -> milvus.proto.streaming.TextFlushSegmentProgress
	53,  // 52: milvus.proto.streaming.ProduceRequest.produce:type_name -> milvus.proto.streaming.ProduceMessageRequest
	54,  // 53: milvus.proto.streaming.ProduceRequest.close:type_name -> milvus.proto.streaming.CloseProducerRequest
	10,  // 54: milvus.proto.streaming.CreateProducerRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	96,  // 55: milvus.proto.streaming.ProduceMessageRequest.message:type_name -> milvus.proto.messages.Message
	56,  // 56: milvus.proto.streaming.ProduceResponse.create:type_name -> milvus.proto.streaming.CreateProducerResponse
	57,  // 57: milvus.proto.streaming.ProduceResponse.produce:type_name -> milvus.proto.streaming.ProduceMessageResponse
	60,  // 58: milvus.proto.streaming.ProduceResponse.close:type_name -> milvus.proto.streaming.CloseProducerResponse
	58,  // 59: milvus.proto.streaming.ProduceResponse.rate_limit:type_name -> milvus.proto.streaming.ProduceRateLimitResponse
	59,  // 60: milvus.proto.streaming.ProduceMessageResponse.result:type_name -> milvus.proto.streaming.ProduceMessageResponseResult
	43,  // 61: milvus.proto.streaming.ProduceMessageResponse.error:type_name -> milvus.proto.streaming.StreamingError
	5,   // 62: milvus.proto.streaming.ProduceRateLimitResponse.state:type_name -> milvus.proto.streaming.WALRateLimitState
	97,  // 63: milvus.proto.streaming.ProduceMessageResponseResult.id:type_name -> milvus.proto.common.MessageID
	104, // 64: milvus.proto.streaming.ProduceMessageResponseResult.txnContext:type_name -> milvus.proto.messages.TxnContext
	105, // 65: milvus.proto.streaming.ProduceMessageResponseResult.extra:type_name -> google.protobuf.Any
	97,  // 66: milvus.proto.streaming.ProduceMessageResponseResult.last_confirmed_id:type_name -> milvus.proto.common.MessageID
	65,  // 67: milvus.proto.streaming.ConsumeRequest.create_vchannel_consumer:type_name -> milvus.proto.streaming.CreateVChannelConsumerRequest
	64,  // 68: milvus.proto.streaming.ConsumeRequest.create_vchannel_consumers:type_name -> milvus.proto.streaming.CreateVChannelConsumersRequest
	68,  // 69: milvus.proto.streaming.ConsumeRequest.close_vchannel:type_name -> milvus.proto.streaming.CloseVChannelConsumerRequest
	62,  // 70: milvus.proto.streaming.ConsumeRequest.close:type_name -> milvus.proto.streaming.CloseConsumerRequest
	10,  // 71: milvus.proto.streaming.CreateConsumerRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	65,  // 72: milvus.proto.streaming.CreateVChannelConsumersRequest.create_vchannels:type_name -> milvus.proto.streaming.CreateVChannelConsumerRequest
	38,  // 73: milvus.proto.streaming.CreateVChannelConsumerRequest.deliver_policy:type_name -> milvus.proto.streaming.DeliverPolicy
	39,  // 74: milvus.proto.streaming.CreateVChannelConsumerRequest.deliver_filters:type_name -> milvus.proto.streaming.DeliverFilter
	67,  // 75: milvus.proto.streaming.CreateVChannelConsumersResponse.create_vchannels:type_name -> milvus.proto.streaming.CreateVChannelConsumerResponse
	43,  // 76: milvus.proto.streaming.CreateVChannelConsumerResponse.error:type_name -> milvus.proto.streaming.StreamingError
	71,  // 77: milvus.proto.streaming.ConsumeResponse.create:type_name -> milvus.proto.streaming.CreateConsumerResponse
	72,  // 78: milvus.proto.streaming.ConsumeResponse.consume:type_name -> milvus.proto.streaming.ConsumeMessageReponse
	67,  // 79: milvus.proto.streaming.ConsumeResponse.create_vchannel:type_name -> milvus.proto.streaming.CreateVChannelConsumerResponse
	66,  // 80: milvus.proto.streaming.ConsumeResponse.create_vchannels:type_name -> milvus.proto.streaming.CreateVChannelConsumersResponse
	69,  // 81: milvus.proto.streaming.ConsumeResponse.close_vchannel:type_name -> milvus.proto.streaming.CloseVChannelConsumerResponse
	73,  // 82: milvus.proto.streaming.ConsumeResponse.close:type_name -> milvus.proto.streaming.CloseConsumerResponse
	98,  // 83: milvus.proto.streaming.ConsumeMessageReponse.message:type_name -> milvus.proto.common.ImmutableMessage
	10,  // 84: milvus.proto.streaming.StreamingNodeManagerAssignRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	10,  // 85: milvus.proto.streaming.StreamingNodeManagerRemoveRequest.pchannel:type_name -> milvus.proto.streaming.PChannelInfo
	80,  // 86: milvus.proto.streaming.StreamingNodeMetrics.wals:type_name -> milvus.proto.streaming.StreamingNodeWALMetrics
	10,  // 87: milvus.proto.streaming.StreamingNodeWALMetrics.info:type_name -> milvus.proto.streaming.PChannelInfo
	81,  // 88: milvus.proto.streaming.StreamingNodeWALMetrics.rw:type_name -> milvus.proto.streaming.StreamingNodeRWWALMetrics
	82,  // 89: milvus.proto.streaming.StreamingNodeWALMetrics.ro:type_name -> milvus.proto.streaming.StreamingNodeROWALMetrics
	79,  // 90: milvus.proto.streaming.StreamingNodeManagerCollectStatusResponse.metrics:type_name -> milvus.proto.streaming.StreamingNodeMetrics
	6,   // 91: milvus.proto.streaming.VChannelMeta.state:type_name -> milvus.proto.streaming.VChannelState
	85,  // 92: milvus.proto.streaming.VChannelMeta.collection_info:type_name -> milvus.proto.streaming.CollectionInfoOfVChannel
	87,  // 93: milvus.proto.streaming.CollectionInfoOfVChannel.partitions:type_name -> milvus.proto.streaming.PartitionInfoOfVChannel
	86,  // 94: milvus.proto.streaming.CollectionInfoOfVChannel.schemas:type_name -> milvus.proto.streaming.CollectionSchemaOfVChannel
	106, // 95: milvus.proto.streaming.CollectionSchemaOfVChannel.schema:type_name -> milvus.proto.schema.CollectionSchema
	7,   // 96: milvus.proto.streaming.CollectionSchemaOfVChannel.state:type_name -> milvus.proto.streaming.VChannelSchemaState
	8,   // 97: milvus.proto.streaming.SegmentAssignmentMeta.state:type_name -> milvus.proto.streaming.SegmentAssignmentState
	89,  // 98: milvus.proto.streaming.SegmentAssignmentMeta.stat:type_name -> milvus.proto.streaming.SegmentAssignmentStat
	107, // 99: milvus.proto.streaming.SegmentAssignmentStat.level:type_name -> milvus.proto.data.SegmentLevel
	97,  // 100: milvus.proto.streaming.WALCheckpoint.message_id:type_name -> milvus.proto.common.MessageID
	99,  // 101: milvus.proto.streaming.WALCheckpoint.replicate_config:type_name -> milvus.proto.common.ReplicateConfiguration
	103, // 102: milvus.proto.streaming.WALCheckpoint.replicate_checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	91,  // 103: milvus.proto.streaming.WALCheckpoint.alter_wal_state:type_name -> milvus.proto.streaming.AlterWALState
	108, // 104: milvus.proto.streaming.AlterWALState.target_wal_name:type_name -> milvus.proto.common.WALName
	95,  // 105: milvus.proto.streaming.AlterWALState.configs:type_name -> milvus.proto.streaming.AlterWALState.ConfigsEntry
	9,   // 106: milvus.proto.streaming.AlterWALState.stage:type_name -> milvus.proto.streaming.AlterWALStage
	99,  // 107: milvus.proto.streaming.ReplicateConfigurationMeta.replicate_configuration:type_name -> milvus.proto.common.ReplicateConfiguration
	17,  // 108: milvus.proto.streaming.ReplicateConfigurationMeta.acked_result:type_name -> milvus.proto.streaming.AckedResult
	109, // 109: milvus.proto.streaming.ReplicatePChannelMeta.target_cluster:type_name -> milvus.proto.common.MilvusCluster
	103, // 110: milvus.proto.streaming.ReplicatePChannelMeta.initialized_checkpoint:type_name -> milvus.proto.common.ReplicateCheckpoint
	59,  // 111: milvus.proto.streaming.BroadcastResponse.ResultsEntry.value:type_name -> milvus.proto.streaming.ProduceMessageResponseResult
	110, // 112: milvus.proto.streaming.StreamingNodeStateService.GetComponentStates:input_type -> milvus.proto.milvus.GetComponentStatesRequest
	19,  // 113: milvus.proto.streaming.StreamingCoordBroadcastService.Broadcast:input_type -> milvus.proto.streaming.BroadcastRequest
	21,  // 114: milvus.proto.streaming.StreamingCoordBroadcastService.Ack:input_type -> milvus.proto.streaming.BroadcastAckRequest
	23,  // 115: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateReplicateConfiguration:input_type -> milvus.proto.streaming.UpdateReplicateConfigurationRequest
	25,  // 116: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateWALBalancePolicy:input_type -> milvus.proto.streaming.UpdateWALBalancePolicyRequest
	29,  // 117: milvus.proto.streaming.StreamingCoordAssignmentService.AssignmentDiscover:input_type -> milvus.proto.streaming.AssignmentDiscoverRequest
	44,  // 118: milvus.proto.streaming.StreamingNodeHandlerService.GetReplicateCheckpoint:input_type -> milvus.proto.streaming.GetReplicateCheckpointRequest
	46,  // 119: milvus.proto.streaming.StreamingNodeHandlerService.GetSalvageCheckpoint:input_type -> milvus.proto.streaming.GetSalvageCheckpointRequest
	48,  // 120: milvus.proto.streaming.StreamingNodeHandlerService.GetTextFlushProgress:input_type -> milvus.proto.streaming.GetTextFlushProgressRequest
	51,  // 121: milvus.proto.streaming.StreamingNodeHandlerService.Produce:input_type -> milvus.proto.streaming.ProduceRequest
	61,  // 122: milvus.proto.streaming.StreamingNodeHandlerService.Consume:input_type -> milvus.proto.streaming.ConsumeRequest
	74,  // 123: milvus.proto.streaming.StreamingNodeManagerService.Assign:input_type -> milvus.proto.streaming.StreamingNodeManagerAssignRequest
	76,  // 124: milvus.proto.streaming.StreamingNodeManagerService.Remove:input_type -> milvus.proto.streaming.StreamingNodeManagerRemoveRequest
	78,  // 125: milvus.proto.streaming.StreamingNodeManagerService.CollectStatus:input_type -> milvus.proto.streaming.StreamingNodeManagerCollectStatusRequest
	111, // 126: milvus.proto.streaming.StreamingNodeStateService.GetComponentStates:output_type -> milvus.proto.milvus.ComponentStates
	20,  // 127: milvus.proto.streaming.StreamingCoordBroadcastService.Broadcast:output_type -> milvus.proto.streaming.BroadcastResponse
	22,  // 128: milvus.proto.streaming.StreamingCoordBroadcastService.Ack:output_type -> milvus.proto.streaming.BroadcastAckResponse
	24,  // 129: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateReplicateConfiguration:output_type -> milvus.proto.streaming.UpdateReplicateConfigurationResponse
	28,  // 130: milvus.proto.streaming.StreamingCoordAssignmentService.UpdateWALBalancePolicy:output_type -> milvus.proto.streaming.UpdateWALBalancePolicyResponse
	32,  // 131: milvus.proto.streaming.StreamingCoordAssignmentService.AssignmentDiscover:output_type -> milvus.proto.streaming.AssignmentDiscoverResponse
	45,  // 132: milvus.proto.streaming.StreamingNodeHandlerService.GetReplicateCheckpoint:output_type -> milvus.proto.streaming.GetReplicateCheckpointResponse
	47,  // 133: milvus.proto.streaming.StreamingNodeHandlerService.GetSalvageCheckpoint:output_type -> milvus.proto.streaming.GetSalvageCheckpointResponse
	50,  // 134: milvus.proto.streaming.StreamingNodeHandlerService.GetTextFlushProgress:output_type -> milvus.proto.streaming.GetTextFlushProgressResponse
	55,  // 135: milvus.proto.streaming.StreamingNodeHandlerService.Produce:output_type -> milvus.proto.streaming.ProduceResponse
	70,  // 136: milvus.proto.streaming.StreamingNodeHandlerService.Consume:output_type -> milvus.proto.streaming.ConsumeResponse
	75,  // 137: milvus.proto.streaming.StreamingNodeManagerService.Assign:output_type -> milvus.proto.streaming.StreamingNodeManagerAssignResponse
	77,  // 138: milvus.proto.streaming.StreamingNodeManagerService.Remove:output_type -> milvus.proto.streaming.StreamingNodeManagerRemoveResponse
	83,  // 139: milvus.proto.streaming.StreamingNodeManagerService.CollectStatus:output_type -> milvus.proto.streaming.StreamingNodeManagerCollectStatusResponse
	126, // [126:140] is the sub-list for method output_type
	112, // [112:126] is the sub-list for method input_type
...
func file_streaming_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_streaming_proto_msgTypes[38].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetTextFlushProgressRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[39].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TextFlushSegmentProgress); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[40].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetTextFlushProgressResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_streaming_proto_msgTypes[81].Exporter = func(v interface{}, i int) interface{} {
		...
		file_streaming_proto_msgTypes[82].Exporter = func(v interface{}, i int) interface{} {
		...
		file_streaming_proto_msgTypes[83].Exporter = func(v interface{}, i int) interface{} {
	...
	file_streaming_proto_msgTypes[41].OneofWrappers = []interface{}{
		(*ProduceRequest_Produce)(nil),
		(*ProduceRequest_Close)(nil),
	}
	file_streaming_proto_msgTypes[45].OneofWrappers = []interface{}{
		(*ProduceResponse_Create)(nil),
		(*ProduceResponse_Produce)(nil),
		(*ProduceResponse_Close)(nil),
		(*ProduceResponse_RateLimit)(nil),
	}
	file_streaming_proto_msgTypes[47].OneofWrappers = []interface{}{
		(*ProduceMessageResponse_Result)(nil),
		(*ProduceMessageResponse_Error)(nil),
	}
	file_streaming_proto_msgTypes[51].OneofWrappers = []interface{}{
	...
	file_streaming_proto_msgTypes[60].OneofWrappers = []interface{}{
	...
	file_streaming_proto_msgTypes[70].OneofWrappers = []interface{}{
