...
require (
	...
	github.com/zilliztech/woodpecker v0.1.27 // indirect
...
replace (
	...
	github.com/milvus-io/milvus-proto/go-api/v2 => github.com/zhagnlu/milvus-proto/go-api/v2 v2.6.6-0.20260326064633-dd414ef9b953
